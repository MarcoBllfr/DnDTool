...
{:else if monster}
  <p>
    ...
    <meta name="description" content="Dettagli completi per {monster.name} - D&D 5e" />
  </p>
      ...
      <div class="monster-stats-detailed">
        <div class="basic-stats">
          <div class="stat-row">
            ...
            <strong>Armor Class:</strong> {monster["Armor Class"]}
          </div>
          <div class="stat-row">
            <Icon icon="mdi:heart" />
            <strong>Hit Points:</strong> {monster["Hit Points"]}
          </div>
          <div class="stat-row">
            <Icon icon="mdi:run" />
        ...
        {#if monster["Saving Throws"]}
          <div class="stat-row">
            <strong>Saving Throws:</strong> {monster["Saving Throws"]}
          </div>
        {/if}
        ...
        {#if monster["Damage Vulnerabilities"]}
          <div class="stat-row">
            <strong>Damage Vulnerabilities:</strong> {monster["Damage Vulnerabilities"]}
          </div>
        {/if}
        
        {#if monster["Damage Resistances"]}
          <div class="stat-row">
            <strong>Damage Resistances:</strong> {monster["Damage Resistances"]}
          </div>
        {/if}
        
        {#if monster["Damage Immunities"]}
          <div class="stat-row">
            <strong>Damage Immunities:</strong> {monster["Damage Immunities"]}
          </div>
        {/if}
        
        {#if monster["Condition Immunities"]}
          <div class="stat-row">
            <strong>Condition Immunities:</strong> {monster["Condition Immunities"]}
          </div>
        {/if}
        ...
        <div class="stat-row">
          ...
          <strong>Challenge:</strong> {monster.Challenge}
        </div>
      </div>
    </div>
